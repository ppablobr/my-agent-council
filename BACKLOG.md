...
| BL-002 | Chore | Add ADR process + decision log | Ready | M0 | PM / Eng | `DECISIONS.md`, `docs/adr/` |
| BL-003 | Chore | Add GitHub templates + CI docs checks | Ready | M0 | GitHub Agent / Plan Guardian | `.github/` |
